/* flatpickr v4.6.2,, @license MIT */ ! function(e, t) {
    ...
    var e = function() {
        ...
        a = {
            weekdays: {
                shorthand: ["شنبه", "1 شنبه", "2 شنبه", "3 شنبه", "4 شنبه", "5 شنبه", "جمعه"],
                longhand: ["شنبه", "1 شنبه", "2 شنبه", "3 شنبه", "4 شنبه", "5 شنبه", "جمعه"]
            },
            months: {
            ...
            scrollTitle: "حرکت به پیشرفت",
            toggleTitle: "برای تغییر کلیک کنید",
            amPM: ["صبح", "شب"],
            yearAriaLabel: "سال",
            hourAriaLabel: "ساعت",
